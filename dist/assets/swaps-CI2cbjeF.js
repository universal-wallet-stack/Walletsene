import{cC as A,dh as l,cF as w,cG as D,cH as C,cU as $,cO as h,cI as u,cR as V,d4 as N,c_ as S,cV as M,dG as K,d5 as F,d6 as Q,cD as W,cE as H,d_ as _}from"./index-L5ghIqj-.js";import{S as s}from"./SwapController-DbBHhHGT.js";import"./index-NiqP__4T.js";const q={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",L=a==="x",U=n===",",R=n===".",B=n>="0"&&n<="9";!r&&(c||b||I||L)&&e.preventDefault(),t==="0"&&!U&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(U||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!U&&e.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
