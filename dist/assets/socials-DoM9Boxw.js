import{cC as I,cF as W,dh as l,cG as O,cH as _,cX as S,dq as h,dI as T,c_ as f,cR as F,cI as c,dJ as D,cV as C,dK as N,d2 as M,dL as U,d7 as $,cU as d,d3 as P,dM as j,d4 as u,dN as A,cZ as v,dG as R,dg as y,dO as q}from"./index-L5ghIqj-.js";const z=I`
  :host {
...
`;var k=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let L=class extends _{constructor(){super(),this.unsubscribe=[],this.checked=U.state.isLegalCheckboxChecked,this.unsubscribe.push(U.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var E;const{termsConditionsUrl:e,privacyPolicyUrl:o}=h.state,r=(E=h.state.features)==null?void 0:E.legalCheckbox,s=!!(e||o)&&!!r&&!this.checked,a=s?-1:void 0;return c`
    ...
    `}};L.styles=G;k([l()],L.prototype,"checked",void 0);L=k([O("w3m-connect-socials-view")],L);const V=I`
  wui-logo {
    width: 80px;
    height: 80px;
